    ...
    pub fn data(&self, config: &Config, data: &mut Data) {
        ...
        for player in &self.players {
            ...
            let player_data = PlayerData {
                ...
                total_hits: player.total_hits(self).unwrap_or_default(),
                damage: player.damage(self).unwrap_or_default(),
                round_kills: player.round_kills(self).unwrap_or_default(),
        ...
        data.local_player = PlayerData {
            ...
            total_hits: local_player.total_hits(self).unwrap_or_default(),
            damage: local_player.damage(self).unwrap_or_default(),
            round_kills: local_player.round_kills(self).unwrap_or_default(),
            sound: None,
